...
from app.v2.services.recommendation_intents import (
    recommendation_validation_intents,
    validated_recommendation_intent,
)
...
class DeepSeekProvider:
    ...
    def _validate_recommendation_candidates(
        ...
        for candidate in generation.candidates:
            validated_recommendation_intent(candidate, file_record)
    ...
    def _recommendation_validation_intents(
        ...
        return recommendation_validation_intents(candidate, file_record)
    ...
    def _safe_dataset_profile(self, file_record: FileModel) -> dict[str, Any]:
        ...
        return {
            "filename": safe_display_filename(file_record.filename),
